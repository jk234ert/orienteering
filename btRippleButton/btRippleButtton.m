...
-(void)handleTap:(id)sender {
    ...
    {
        UIView *highlightView = [[self subviews] objectAtIndex:([[self subviews] count]-1)];
        if(highlightView.tag == 1)
        {
...
{
    UIView *highlightView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height)];
    highlightView.backgroundColor = [UIColor colorWithWhite:1 alpha:0.8];
    [highlightView setTag:1];
